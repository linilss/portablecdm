      ...
      */
        ...
        return(
            <View style={styles.container}>
                <TopHeader title="Overview" navigation={this.props.navigation} firstPage/>
                    ...
                    <List>
                        {
                          ...
                          this.search(portCalls, searchTerm).filter(function(portCall) { return portCall.vessel.imo == favVesselImo}).map( (portCall) => (
                                <ListItem
                                    roundAvatar
